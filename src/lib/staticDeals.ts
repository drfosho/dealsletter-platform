...
export const staticDeals = [
  ...
  },
  {
    id: 21,
    title: "712 S 2nd St",
    address: "712 S 2nd St",
    city: "San Jose",
    state: "CA",
    zipCode: "95112",
    location: "San Jose, CA 95112",
    type: "Historic SoFA District Triplex",
    ...
    features: [
      ...
      "SoFA District Location",
      "WalkScore 89",
      "Separate Meters"
    ],
    description: "Historic 1898 Victorian triplex in San Jose's red-hot SoFA District. 42 days on market with $64K price cut - seller motivation HIGH. Negotiate to $950K-$1M for strong profits. Recent comps support $1.622M ARV. 6-month flip timeline.",
    riskLevel: "medium",
    timeframe: "6 months",
    cashRequired: 167278,
    totalROI: 195.8,
    isDraft: false,
    listingUrl: "https://www.zillow.com/homedetails/712-S-2nd-St-San-Jose-CA-95112/19713143_zpid/",
    listingSource: "Zillow",
    annualizedReturn: 391.6,
    negotiationNotes: "Listed $1,150K, target $950K-$1M. Already dropped $64K - seller motivated. Use 42 DOM and 1898 construction risks as leverage.",
    monthlyRent: 0,
    monthlyCashFlow: 0,
    capRate: 0,
    createdAt: new Date(),
  ...
  {
    id: 22,
    title: "1420 Orlando Dr",
    address: "1420 Orlando Dr",
    city: "San Jose",
    state: "CA",
    zipCode: "95122",
    location: "San Jose, CA 95122",
    type: "East San Jose Value-Add",
    propertyType: "Single Family",
    strategy: "Fix & Flip",
    investmentStrategy: "Fix & Flip",
    price: 850000,
    ...
    features: [
      ...
      "Bonus Space",
      "Fast 3-Month Flip",
      "Quick Capital Turnaround"
    ],
    description: "3BR/1BA with ADU in East San Jose. Fast 3-month turnaround flip with $70K-$81K profit potential. ADU provides value differentiation. Solid base hit with 52-61% ROI.",
    riskLevel: "low",
    timeframe: "3 months",
    cashRequired: 134636,
    totalROI: 52.0,
    isDraft: false,
    listingUrl: "https://www.zillow.com/homedetails/1420-Orlando-Dr-San-Jose-CA-95122/19725833_zpid/",
    listingSource: "Zillow",
    annualizedReturn: 207.9,
    executionNotes: "Key to profitability is hitting 3-month timeline. Have contractor ready Day 1, order all materials before close. Market the ADU aggressively as value differentiator.",
    monthlyRent: 0,
    monthlyCashFlow: 0,
    capRate: 0,
    createdAt: new Date(),
  ...
  {
    id: 23,
    title: "110 Hilborn St",
    address: "110 Hilborn St",
    city: "Vallejo",
    state: "CA",
    zipCode: "94590",
    location: "Vallejo, CA 94590",
    type: "Vallejo Heights Multifamily",
    propertyType: "Multifamily (9 units)",
    strategy: "Buy & Hold",
    investmentStrategy: "Buy & Hold",
    units: 9,
    isMultiFamily: true,
    ...
    downPaymentPercent: 25,
    capRate: 6.77,
    proFormaCapRate: 8.43,
    monthlyRent: 17835,
    monthlyCashFlow: 1049,
    proFormaCashFlow: 3817,
    status: "active",
    daysOnMarket: 0,
    confidence: "very high",
    images: ["/api/placeholder/400/300"],
    ...
    features: [
      "Recently Renovated",
      "15 Covered Parking Spaces",
      "Onsite Laundry",
      "RUBS Potential",
      "100% Occupied",
      "Turnkey Condition"
    ],
    description: "Rare hybrid property: 1 SFR + 8-unit apartment building in Vallejo Heights. Recently renovated, turnkey condition. Current 6.77% cap rate, 8.43% proforma with RUBS and rent optimization. Strong value-add opportunity with multiple levers.",
    riskLevel: "low",
    timeframe: "Immediate",
    cashRequired: 538650,
    totalROI: 173.2,
    isDraft: false,
    listingUrl: "https://www.loopnet.com/Listing/110-Hilborn-Ave-Vallejo-CA/38057441/?action=sale-lock",
    listingSource: "LoopNet",
    rentAnalysis: {
      currentRentPerUnit: 1982,
      marketRentPerUnit: 2048,
      monthlyRentUpside: 602,
      totalCurrentMonthlyRent: 17835,
      totalMarketMonthlyRent: 18437,
      percentRentIncrease: 3.4
    },
    fiveYearIRR: 22.4,
    fiveYearProfit: 932695,
    valueAddStrategy: "Implement RUBS ($8K/yr NOI), raise rents to market ($11.5K/yr), add parking fees ($5.4K/yr). Total NOI increase: $33K/year",
    roi: 173.2,
    createdAt: new Date(),
    updatedAt: new Date()
  },
  {
    id: 24,
    title: "1014 Uptown Aly",
    address: "1014 Uptown Aly",
    city: "Sacramento",
    state: "CA",
    zipCode: "95818",
    location: "Sacramento, CA 95818",
    type: "Downtown Sacramento House Hack",
    propertyType: "Duplex",
    strategy: "House Hack",
    investmentStrategy: "House Hack",
    units: 2,
    ...
    description: "Brand new 2025 duplex in Downtown Sacramento. Perfect house hack: live in 2BR/2BA unit (1,027 sq ft), rent 1BR/1BA unit for $1,750/mo. Effective rent $794/mo ($234/mo after tax benefits). Build $175K+ equity in 3 years while living essentially free!",
    riskLevel: "low",
    timeframe: "Immediate",
    cashRequired: 47940,
    totalROI: 265,
    isDraft: false,
    rentAnalysis: {
      currentRentPerUnit: 1750,
      marketRentPerUnit: 1750,
      monthlyRentUpside: 0,
      totalCurrentMonthlyRent: 1750,
      totalMarketMonthlyRent: 1750,
      percentRentIncrease: 0
    },
    effectiveMonthlyRent: 794,
    effectiveRentAfterTaxBenefits: 234,
    threeYearEquity: 175117,
    marketComparison: "Comparable 2BR/2BA apartments rent for $2,200-$2,500/mo. House hacking saves $16,800-$20,400/year!",
    houseHackAdvantages: [
      "Live rent-free in brand new construction",
      "Zero maintenance for years",
      "Solar panels = $0 electric bills",
      "Build $175K equity in 3 years",
      "Tax benefits reduce effective cost to $234/mo",
      "FHA 3.5% down payment option"
    ],
    roi: 265,
    createdAt: new Date(),
    updatedAt: new Date()
