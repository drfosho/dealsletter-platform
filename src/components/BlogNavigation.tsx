...
export default function BlogNavigation() {
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="md:hidden">
            <button
              ...
              className="p-2 text-primary hover:text-accent transition-colors min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg hover:bg-muted/10"
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden fixed top-[60px] left-0 right-0 z-40 bg-background/95 backdrop-blur-xl border-b border-border/20 animate-slide-down">
