  ...
  return (
    <div
      style={{
        ...
        border: `1px solid ${open ? 'var(--border-strong)' : 'var(--hairline)'}`,
        borderRadius: 12,
        marginBottom: 8,
        overflow: 'hidden',
    ...
    >
      ...
      >
        <span style={{ fontSize: 15, fontWeight: 500, color: 'var(--text)', flex: 1, paddingRight: 16 }}>
          {faq.question}
        </span>
        <Chevron open={open} />
      </button>
...
export default function V3FaqPage() {
  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '72px 40px 120px' }}>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 10, justifyContent: 'center', marginTop: 22, flexWrap: 'wrap' }}>
          <Link href="/contact" className="app-btn" style={{ padding: '10px 18px', fontSize: 13 }}>
            Contact us →
          </Link>
          <Link href="/v3/signup" className="app-btn-ghost" style={{ padding: '10px 18px', fontSize: 13 }}>
            Try it free →
          </Link>
        </div>
      </section>
