    ...
    <div className="fixed inset-0 z-[9999] overflow-hidden">
      ...
      <div className="relative h-full flex items-end md:items-center justify-center p-0 md:p-4">
        ...
        <div className="p-4 md:p-6 border-b border-border/20 flex-shrink-0">
          ...
          {deal.isOnMarket && deal.avm && deal.price && Math.abs(deal.avm - deal.price) > 50000 && (
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-amber-800 dark:text-amber-300 space-y-1">
                    <p>The price displayed (<strong>${deal.avm?.toLocaleString()}</strong>) is an automated valuation estimate.</p>
                    <p>Actual listing price: <strong>${deal.price.toLocaleString()}</strong> ({((deal.price - deal.avm!) / deal.avm! * 100).toFixed(1)}% {deal.price > deal.avm! ? 'higher' : 'lower'})</p>
